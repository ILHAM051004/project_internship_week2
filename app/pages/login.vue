  ...
  <div class="flex min-h-screen w-screen bg-slate-50">
    ...
    <div class="flex min-h-screen w-1/2 items-center justify-center px-8 py-10">
      ...
      <div class="w-full max-w-md">
        ...
        <div class="rounded-3xl border border-slate-200 bg-white p-7 shadow-lg shadow-slate-900/5 sm:p-9">

          <div class="mb-7">
            <h2 class="text-2xl text-center font-semibold tracking-tight text-slate-800">
              Welcome
            </h2>
          </div>
          ...
          <form class="space-y-5" @submit.prevent="handleLogin">
            ...
            <div v-if="authStore.error" class="rounded-xl border border-red-100 bg-red-50 px-4 py-3">
            ...
            <button type="submit" :disabled="authStore.loading"
              ...
              <svg v-if="authStore.loading" xmlns="http://www.w3.org/2000/svg" class="mr-2 h-4 w-4 animate-spin"
                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M21 12a9 9 0 1 1-6.22-8.56" />
              </svg>
